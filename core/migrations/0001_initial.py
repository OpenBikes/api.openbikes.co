# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-22 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_name', models.TextField(verbose_name='API name')),
        ...
        migrations.AddField(
            model_name='archive',
            name='city',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='archives', to='core.City'),
        ),
    ]
